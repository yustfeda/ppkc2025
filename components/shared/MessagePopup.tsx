                             ...
                             {isAdmin && currentThread && onToggleMessagingPermission && (
                                <div className="flex items-center gap-2 mt-1">
                                    ...
                                    <label htmlFor="messagingToggle" className="cursor-pointer relative inline-flex items-center">
                                        ...
                                        />
                                        <div className="w-9 h-5 bg-gray-400 peer-focus:outline-none rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-green-500"></div>
                                    </label>
                                </div>
                            )}
                        </div>
